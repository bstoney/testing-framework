...
namespace Testing.UnitTest
{
	...
	public static class Assert
	{
		...
		private static AssertionException GetException( string message, params object[] args )
		{
		...
		{
			throw Assert.GetException( message, args );
		}
		...
		{
			throw Assert.GetException( message, null );
		}
		...
		{
			throw Assert.GetException( string.Empty, 1, null );
		}
