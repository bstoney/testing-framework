...
namespace Testing.UnitTest
{
	...
	/// </summary>
	public abstract class TypeAsserter : AsserterBase
	{
		/// <summary>
		/// The expected Type
		/// </summary>
		...
		protected TypeAsserter( Type expected, object actual, string message, params object[] args )
			: base( message, args )
		{
	...
	public class AssignableFromAsserter : TypeAsserter
	{
		...
		public AssignableFromAsserter( Type expected, object actual, string message, params object[] args )
	...
	public class NotAssignableFromAsserter : TypeAsserter
	{
		...
		public NotAssignableFromAsserter( Type expected, object actual, string message, params object[] args )
			: base( expected, actual, message, args ) { }
	...
	public class InstanceOfTypeAsserter : TypeAsserter
	{
		...
		/// <param name="message">The message to display in case of failure</param>
		/// <param name="args">Arguments to use in formatting the message</param>
		public InstanceOfTypeAsserter( Type expected, object actual, string message, params object[] args )
			: base( expected, actual, message, args ) { }
		...
		protected override string Expectation
		{
			get { return string.Format( "Object to be instance of {0}", expected ); }
		}
	}
	...
	public class NotInstanceOfTypeAsserter : TypeAsserter
	{
		...
		/// <param name="message">The message to display in case of failure</param>
		/// <param name="args">Arguments to use in formatting the message</param>
		public NotInstanceOfTypeAsserter( Type expected, object actual, string message, params object[] args )
			: base( expected, actual, message, args ) { }
		...
		protected override string Expectation
		{
			get { return string.Format( "Object not an instance of {0}", expected ); }
		}
	}
